...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"Regions";
    self.regionTitles = @[@"Belarus 🇧🇾", @"Kazakhstan 🇰🇿", @"Russia 🇷🇺", @"United States 🇺🇸", @"Germany 🇩🇪", @"Poland 🇵🇱", @"Ukraine 🇺🇦", @"Uzbekistan 🇺🇿", @"Finland 🇫🇮", @"Egypt 🇪🇬", @"Turkey 🇹🇷", @"United Kingdom 🇬🇧", @"Saudi Arabia 🇸🇦", @"Taiwan 🇹🇼", @"Hong Kong 🇭🇰", @"Macao 🇲🇴", @"Japan 🇯🇵", @"South Korea 🇰🇷", @"Australia 🇦🇺", @"Canada 🇨🇦", @"Argentina 🇦🇷", @"Philippines 🇵🇭", @"Laos 🇱🇦", @"Malaysia 🇲🇾", @"Thailand 🇹🇭", @"Singapore 🇸🇬", @"Indonesia 🇮🇩", @"Vietnam 🇻🇳", @"Anguilla 🇦🇮", @"Panama 🇵🇦", @"France 🇫🇷", @"Italy 🇮🇹", @"Pakistan 🇵🇰", @"Denmark 🇩🇰", @"Norway 🇳🇴", @"Sudan 🇸🇩", @"Romania 🇷🇴", @"United Arab Emirates 🇦🇪", @"Lebanon 🇱🇧", @"Mexico 🇲🇽", @"Brazil 🇧🇷", @"Kuwait 🇰🇼", @"Algeria 🇩🇿"];
    ...
    @{@"area": @"Uzbekistan 🇺🇿", @"name": @"Uzbekistan", @"code": @"UZ", @"mcc": @"434", @"mnc": @"04"},
