...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
            ...
            case 14:
                return [self createSwitchCellWithTitle:@"Upload Region"
                                                Detail:@"Show Upload Region Flag Next to Username"
                                                   Key:@"upload_region"];
            case 15:
                return [self createSwitchCellWithTitle:@"Pure Mode"
                                                Detail:@"Hide overlay buttons and titles for clean view"
                                                   Key:@"pure_mode"];
            case 16:
                return [self createSwitchCellWithTitle:@"Anti-Burn-In (AMOLED)"
                                                Detail:@"Dim static overlay buttons to prevent screen burn-in"
                                                   Key:@"anti_burn_in"];
            case 17:
                return [self createSwitchCellWithTitle:@"Fast Download"
                                                Detail:@"1-tap save video/photo directly to Photos without prompt"
                                                   Key:@"skip_download_selector"];
            default:
                break;
        }
        ...
        switch (indexPath.row) {
            ...
            case 4:
                return [self createSwitchCellWithTitle:@"Video Views Count"
                                                Detail:@"Show the number of views on videos (TikTok You)"
                                                   Key:@"video_views_count"];
            default:
                break;
        }
            ...
            case 9:
                return [self createSwitchCellWithTitle:@"Enable Flex"
                                                Detail:@"Developers Only, DON'T touch it if you don't know what you are doing."
                                                   Key:@"flex_enebaled"];
            case 10:
                return [self createSwitchCellWithTitle:@"Sort Comments by Time"
                                                Detail:@"Sort comments chronologically (TikTok You)"
                                                   Key:@"comment_sort_time"];
            case 11:
                return [self createSwitchCellWithTitle:@"Auto-Streak Reminder"
                                                Detail:@"Remind and maintain streaks in direct messages (TikTok You)"
                                                   Key:@"auto_streak_reminder"];
            default:
                break;
        }
