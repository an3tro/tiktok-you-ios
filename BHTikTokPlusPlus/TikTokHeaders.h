...
@property (nonatomic, assign, readwrite) BOOL isPersonalVerified;
@property (nonatomic, copy, readwrite) NSString *customVerify;
@property (nonatomic, copy, readwrite) NSString *enterpriseVerifyReason;
@property (nonatomic, assign, readwrite) NSInteger verificationType;
@end
